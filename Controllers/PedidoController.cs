...
namespace ProjetoFood.Controllers
{
    public class PedidoController : Controller
    {
            ...
            public IActionResult Checkout(Pedido pedido)
            {
                ...
                {
                    ModelState.AddModelError("", "O seu carrinho esta vazio, deve incluir um produto");
                }

                // se tiver itens no pedido, percorre cada item e soma a quantidade de itens e calcula o total do pedido
